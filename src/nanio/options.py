...
The options file is the persistent on-disk config for `nanio serve`.
It carries server tunables under a `[server]` table and credentials
under `[[users]]` (consumed separately by
